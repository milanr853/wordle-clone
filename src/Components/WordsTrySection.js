    ...
    return (
      ...
      >
        <Grid
          ...
          className={`letterHolderOfRow${ID}`}
          justifyContent="center"
          alignContent="center"
          id={`letterHolder${0}OfRow${ID}`}
        >
          <Text
            className={`letter letterOfRow${ID}`}
            id={`letter${ID}0`}
            fontWeight="semibold"
            fontSize={
              HeightLessThan450
                ? "16px"
                : LessThan350 || HeightLessThan550
                  ? "22px"
                  : "30px"
            }
          ></Text>
  ...
  return (
    <>
      <Flex
        justifyContent="center"
        alignItems="center"
        w={LessThan350 ? "100%" : "350px"}
        h={HeightMoreThan720 ? "470px" : "70%"}
        className="tryBoxOuterWrapper"
      >
        <Grid
          w="100%"
          h="90%"
